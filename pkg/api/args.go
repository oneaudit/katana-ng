...
pipelines offering both headless and non-headless crawling.`)
	...
	flagSet.CreateGroup("input", "Input",
		...
		flagSet.StringVar(&options.EndpointsFile, "endpoints", "", "additional endpoints to crawl (ex: one URL per line, junk lines allowed)"),
	...
	flagSet.CreateGroup("filter", "Filter",
		...
		flagSet.BoolVarP(&options.DisableDefaultExtensionFilter, "disable-default-extension-filter", "ddef", false, "disable the default extension filter"),
